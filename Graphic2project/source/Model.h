...
public:
	...
	void CreateBuffers(ID3D11Device* device, unsigned int numIndices, const unsigned int* Indices);
	void CreateTexture(ID3D11Device* device, const wchar_t* filename, D3D11_SAMPLER_DESC* p_sampler);
